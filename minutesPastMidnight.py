...
def calcSunRiseSetUTC( julianDate2000, latitude, longitude, altitude=0, type="Daylight"):
...
def calcSunRiseSet( julianDate2000, latitude, longitude, timezone, dst, altitude=0, type="Daylight"):
    """Calculate sunrise/sunset the given day at the given location on earth (in minutes)
    """
    rtimeUTC, stimeUTC = calcSunRiseSetUTC(julianDate2000, latitude, longitude, altitude, type)
    # calculate local sunrise time (in minutes)
    rnewTimeUTC, snewTimeUTC = calcSunRiseSetUTC(julianDate2000 + rtimeUTC/1440.0, latitude, longitude, altitude)
    ...
    rnewTimeUTC, snewTimeUTC = calcSunRiseSetUTC(julianDate2000 + stimeUTC/1440.0, latitude, longitude, altitude)
...
date = datetime.datetime(2019,6,24)
Rise, Set = calcSunRiseSet(getJD(date), +52.16, -106.54, -6, 0, 0)
